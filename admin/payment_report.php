...
$pdf->Write(0, 'Payments Report for period between '.$_REQUEST['from'].' And '.$_REQUEST['to'],'',0,'L',true,0,false,false,0);
...
$tbl .= '
   <tr>
   <td colspan="4" align="right"><strong>Total</strong></td><td align="right"><strong>Kshs. '.number_format($total,2).'</strong></td>';
...
$pdf->Output('payments_report_'.$_REQUEST['from'].'_'.$_REQUEST['to'].'.pdf', 'I');
?>