...
<div class="inner-block" >
    <div class="product-block ">
    	<div class="pro-head">
    		<h2>Payment for Movie <?php echo $r['name'];?> by <?php echo $row['firstname'].' '.$row['lastname'];?></h2>
    	</div> 

      <div class="col-md-8 chit-chat-layer1-left">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                  Payment for Movie <?php echo $r['name'];?> by <?php echo $row['firstname'].' '.$row['lastname'];?>
                            </div>
    ...
    <div><a target="blank" class="btn btn-success" href="reportpayment.php?id=<?php echo $_REQUEST['id'];?>">Report</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="payments.php">Go Back</a></div>
