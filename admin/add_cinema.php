...
<div class="inner-block">
    <div class="product-block">
      ...
      <div class="col-md-10 col-md-offset-1 compose-right">
			 ...
			 $sel=mysqli_query($con,"select * from cinemas where name='".$_REQUEST['name']."'");
			 if(mysqli_num_rows($sel)>0){
			 echo "<img src='images/1433077051_cancel.png' width='24' height='24'/><span style='color:red'>That cinema hall already exists!</span>";
			 }else{
			 $sql = mysqli_query($con,"insert into cinemas(name,number_of_seats,address)values('".$_REQUEST['name']."', '".$_REQUEST['seats']."', '".$_REQUEST['address']."')") or die(mysqli_error($con));
			 if( $sql){
			 echo "<img src='images/1433075297_ok-green.png'/><span style='color:green'>Successfully inserted cinema hall! Add another...</span>";
			 }else{
			 ...
			 ?>
							...
							<form onSubmit="return validateForm()" name="cinema" id="cinema" class="com-mail" method="post">
								...
								<textarea rows="6" placeholder="Address" name="address"></textarea>
