...
<div class="inner-block" >
    <div class="product-block ">
    	<div class="pro-head">
    		<h2><?php echo $row['firstname'].' '.$row['lastname'];?>`s Comment</h2>
    	</div>

      <div class="col-md-6 chit-chat-layer1-left">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                  <?php echo $row['firstname'].' '.$row['lastname'];?>`s Comment
                            </div>
    ...
    <div><a class="btn btn-info" href="reply.php?id=<?php echo $_REQUEST['id'];?>">Reply</a>&nbsp;&nbsp;&nbsp;&nbsp;<a target="blank" class="btn btn-success" href="reportcomment.php?id=<?php echo $_REQUEST['id'];?>">Report</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="comments.php">Go Back</a></div>
