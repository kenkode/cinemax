...
<!--icons-css-->
<link href="Font-Awesome-master/css/font-awesome.css" rel="stylesheet"> 
<!--Google Fonts-->
...
<div class="page-container">	
   <div class="left-content">
	   <div class="mother-grid-inner">
        ...
        $selm=mysqli_query($con,"select * from booking") or die(mysqli_error($con));
		$customers=mysqli_num_rows($selm);

		$mov=mysqli_query($con,"select * from movies") or die(mysqli_error($con));
		$movies=mysqli_num_rows($mov);

		$cin=mysqli_query($con,"select * from cinemas") or die(mysqli_error($con));
		$cinemas=mysqli_num_rows($cin);

		$com=mysqli_query($con,"select * from comments") or die(mysqli_error($con));
		$comments=mysqli_num_rows($com);

        $selp=mysqli_query($con,"select sum(price) as total from booking left join movies on booking.movie_id=movies.id") or die(mysqli_error($con));
        $row=mysqli_fetch_array($selp,MYSQLI_ASSOC);
        $payment = $row['total'];
        ?>
<!--heder end here-->
...
<!--market updates updates-->
	 <div class="market-updates">
			...
			<div class="col-md-4 market-update-gd">
				...
				<div class="market-update-block clr-block-1">
				 <div class="col-md-8 market-update-left">
					<h3>Kshs.<?php echo number_format($payment,2)?></h3>
					<h4>Movie Sales</h4>
					<p>Total Sales</p>
				  </div>
		...
		<div class="market-updates">
			<div class="col-md-4 market-update-gd">
				<a href="movies.php">
				<div class="market-update-block clr-block-1 hov" style="background-color:#9922cc;">
					<div class="col-md-8 market-update-left">
						<h3><?php echo $movies;?></h3>
						<h4>Movies</h4>
						<p>Total Movies</p>
					</div>
					<div class="col-md-4 market-update-right">
			...
			<div class="col-md-4 market-update-gd">
				<a href="cinema.php">
				<div class="market-update-block clr-block-4 hov" style="background-color:#ff3224">
					<div class="col-md-8 market-update-left">
						<h3><?php echo $cinemas;?></h3>
						<h4>Cinema Halls</h4>
						<p>Total Cinema Halls</p>
					</div>
					<div class="col-md-4 market-update-right">
						<i> </i>
					</div>
			...
			<div class="col-md-4 market-update-gd">
				<a href="comments.php">
				<div class="market-update-block clr-block-3" style="background-color:#3c3c3c">
					<div class="col-md-8 market-update-left">
...
<div class="copyrights">
	 <p>© 2016 OCB. All Rights Reserved | Design by  <a href="#">Kelvin</a> </p>
</div>	
