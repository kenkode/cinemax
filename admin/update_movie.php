...
<div class="inner-block">
   <div class="product-block">
      ...
      <div class="col-md-10 col-md-offset-1 compose-right">
			 ...
			 if(((is_uploaded_file($_FILES['image']['tmp_name'])) == "" && (is_uploaded_file($_FILES['preview']['tmp_name'])) != "")){
             $preview = addslashes(file_get_contents($_FILES['preview']['tmp_name']));
                                $image_name = addslashes($_FILES['preview']['name']);
                                $image_size = getimagesize($_FILES['preview']['tmp_name']);

                                move_uploaded_file($_FILES["preview"]["tmp_name"], "previews/" . $_FILES["preview"]["name"]);
                                $location = "previews/" . $_FILES["preview"]["name"];
             
			 $sql = mysqli_query($con,"update movies set name='".$_REQUEST['name']."',genre='".$_REQUEST['genre']."',price='".$a."',description='".$_REQUEST['description']."',preview='".$location."',image='".$row['image']."', age='".$_REQUEST['age']."', year='".$_REQUEST['year']."', rating='".$_REQUEST['rating']."', country='".$_REQUEST['country']."' where id='".$_REQUEST['id']."'") or die(mysqli_error($con));
			 if( $sql){
			 echo "<img src='images/1433075297_ok-green.png'/><span style='color:green'>Successfully updated movie!</span>";
			 }else{
	        ...
	        $image = addslashes(file_get_contents($_FILES['image']['tmp_name']));
			 ...
			 $sql = mysqli_query($con,"update movies set name='".$_REQUEST['name']."',genre='".$_REQUEST['genre']."',price='".$a."',description='".$_REQUEST['description']."',image='".$location."',preview='".$row['preview']."', age='".$_REQUEST['age']."', year='".$_REQUEST['year']."', rating='".$_REQUEST['rating']."', country='".$_REQUEST['country']."' where id='".$_REQUEST['id']."'") or die(mysqli_error($con));
			 if( $sql){
			 echo "<img src='images/1433075297_ok-green.png'/><span style='color:green'>Successfully updated movie!</span>";
			 }else{
			 echo "<img src='images/1433077051_cancel.png' width='24' height='24'/><span style='color:red'>An error occurred in updating!</span>";
			 ...
			 $sql = mysqli_query($con,"update movies set name='".$_REQUEST['name']."',genre='".$_REQUEST['genre']."',price='".$a."',description='".$_REQUEST['description']."',image='".$row['image']."',preview='".$row['preview']."', age='".$_REQUEST['age']."', year='".$_REQUEST['year']."', rating='".$_REQUEST['rating']."', country='".$_REQUEST['country']."' where id='".$_REQUEST['id']."'") or die(mysqli_error($con));
			 if( $sql){
			 echo "<img src='images/1433075297_ok-green.png'/><span style='color:green'>Successfully updated movie!</span>";
			 }else{
			 echo "<img src='images/1433077051_cancel.png' width='24' height='24'/><span style='color:red'>An error occurred in updating!</span>";
			 ...
			 $sql = mysqli_query($con,"update movies set name='".$_REQUEST['name']."',genre='".$_REQUEST['genre']."',price='".$a."',description='".$_REQUEST['description']."',image='".$location."',preview='".$preview_location."', age='".$_REQUEST['age']."', year='".$_REQUEST['year']."', rating='".$_REQUEST['rating']."', country='".$_REQUEST['country']."' where id='".$_REQUEST['id']."'") or die(mysqli_error($con));
			 if( $sql){
			 echo "<img src='images/1433075297_ok-green.png'/><span style='color:green'>Successfully updated movie!</span>";
			 }else{
			 echo "<img src='images/1433077051_cancel.png' width='24' height='24'/><span style='color:red'>An error occurred in updating!</span>";
			 ...
			 ?>
							...
							<form onSubmit="return validateForm()" name="movie" id="movie" class="com-mail" method="post" enctype="multipart/form-data">
...
<label>Year <span style="color:red">*</span>:</label>
								...
								<label>Rating:</label>
								<input value="<?php echo $row['rating']?>" type="number" name="rating" class="rating" min=0 max=5 step=0.1 data-size="xs" data-stars="5">
								<label>Price <span style="color:red">*</span>:</label>
								<div class="input-group">
                                <span class="input-group-addon" style="padding:0px 12px !important;">KES</span>
								<input type="text" name="price" id="price" placeholder="Price" value="<?php echo $row['price']?>">
						    	</div>
						    	<script type="text/javascript">
                                $(document).ready(function() {
                                $('#price').priceFormat();
								...
								<textarea  placeholder="Description" rows="6" name="description"><?php echo $row['description']?></textarea>
