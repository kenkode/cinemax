...
<div class="inner-block" >
    <div class="product-block ">
    	<div class="pro-head">
    		<h2>Booking for Movie <?php echo $r['name'];?> by <?php echo $row['firstname'].' '.$row['lastname'];?></h2>
    	</div> 

      <div class="col-md-8 chit-chat-layer1-left">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                  Booking for Movie <?php echo $r['name'];?> by <?php echo $row['firstname'].' '.$row['lastname'];?>
                            </div>
      ...
      <div class="col-lg-12 col-md-12 event-w3ls">
        <div class="table-responsive">
          ...
          <table class="table table-hover">
                              ...
                              <tr>
                                 <td>Price:</td>
                                  <td>Kshs. <?php echo number_format($r['price'],2)?></td> </tr>
                              </tr>
    ...
    <div><a target="blank" class="btn btn-success" href="reportbooking.php?id=<?php echo $_REQUEST['id'];?>">Report</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-warning" href="booking.php">Go Back</a></div>
